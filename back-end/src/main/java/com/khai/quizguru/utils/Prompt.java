...
public class Prompt {
    ...
    public static final String VOCABULARY_QUIZ_PROMPT = "Provide exactly %d questions of type %s based on the given vocabulary," +
            ...
            "Create the questions switching between: " +
            "1. Cloze question - embedded answer." +
            "2. The question about detail definition of that word." +
            "3. The question using that word in real life" +
