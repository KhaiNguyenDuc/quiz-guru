...
import { EMPTY_NAME, TRY_AGAIN_MSG, USERNAME_EXIST } from "../../utils/Constant";
                  ...
                  <div className="user-info">
                    <div className="user-avatar">
                      ...
                      {user.imagePath === null && imageUrl === undefined? (
                        ...
                        <img src={user?.imagePath ? user.imagePath : imageUrl}  alt="" className="img"/>
                       )}
              ...
              <>
                ...
                <li>
                  <Link to={"/member/library"}>
                    <FontAwesomeIcon icon={"bank"} className="fa-icon" /> Kho từ
                    vựng
                  </Link>
                </li>
                ...
                <li>
                  <Link to={"/member/record"}>
                    <FontAwesomeIcon icon={"note-sticky"} className="fa-icon" />{" "}
                    Lịch sử làm bài
                  </Link>
                </li>
                ...
                <li>
                  <Link onClick={(e) => handleLogout(e)} to={"/"}>
                    <span className="pr-3">
                      <FontAwesomeIcon icon={"sign-out"} className="fa-icon" />
                    </span>
                    Đăng xuất
                  </Link>
                </li>
